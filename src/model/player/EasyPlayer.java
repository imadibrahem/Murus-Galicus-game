...
public class EasyPlayer extends Player{
    ...
    public EasyPlayer(boolean isBlue, Board board, EvaluationFunction evaluationFunction, double totalTime) {
    ...
    private int maximizer(int depth, int alpha, int beta) {
        if (System.currentTimeMillis() - startTime > timeManager.getTimeForMove(rounds - 1) || currentSearchDepth >= 5) {
            timeOut = true;
            return alpha;
        }
