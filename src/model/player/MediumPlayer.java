...
public class MediumPlayer extends Player{
    ...
    public MediumPlayer(boolean isBlue, Board board, EvaluationFunction evaluationFunction, double totalTime) {
    ...
    private int maximizer(int depth, int alpha, int beta) {
        if (System.currentTimeMillis() - startTime > timeManager.getTimeForMove(rounds - 1) || currentSearchDepth >= 7) {
            timeOut = true;
            return alpha;
        }
